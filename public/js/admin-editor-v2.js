...
(function() {
    ...
    function initProjectEditors() {
        ...
        if (!document.querySelector('.add-new-project-card')) {
            ...
            addCard.setAttribute('onclick', "window.parent.postMessage({ source: 'live-editor', action: 'openProjectModal', data: { id: null } }, '*');");
            addCard.innerHTML = `<div class="tilt-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; height:100%; width:100%; min-height:300px; pointer-events:none;">
                <div style="font-size:4rem; color:#0ea5e9; font-weight:bold;">+</div>
                <h3 style="margin-top:15px; color:#fff;">YANGI LOYIHA QO'SHISH</h3>
            </div>`;
    ...
    function initServiceEditors() {
        ...
        if (!document.querySelector('.add-new-service-card')) {
            ...
            addCard.setAttribute('onclick', "window.parent.postMessage({ source: 'live-editor', action: 'openServiceModal', data: { id: null } }, '*');");
            addCard.innerHTML = `<div class="tilt-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; height:100%; width:100%; min-height:300px; pointer-events:none;">
                <div style="font-size:4rem; color:#0ea5e9; font-weight:bold;">+</div>
                <h3 style="margin-top:15px; color:#fff;">YANGI XIZMAT QO'SHISH</h3>
            </div>`;
